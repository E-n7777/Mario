...
public class Creat {
    ...
    public static Flower createFlower(int x, int y) {
        Flower flower = new Flower(new ImageIcon(new ImageIcon("src/image/scene/flower_close.png").getImage().getScaledInstance(20, 20, Image.SCALE_SMOOTH)), FlowerState.CLOSE);
